...
class StatusWidget extends StatefulWidget {
  ...
  StatusWidget(this.statusType, {this.width = double.infinity, this.height = double.infinity, this.clickCallback});
  ...
  Widget _statusWidget(int type) {
    ...
    switch(type) {
      case StatusType.EMPTY:
        statusWidget = Center(
          child: Text("数据为空", style: TextStyle(color: Colours.text_gray_6),),
        );
        break;
      case StatusType.NET_NO:
        statusWidget = Center(
          child: Text("无网络", style: TextStyle(color: Colours.text_gray_6),),
        );
        break;
      case StatusType.NET_ERROR:
        statusWidget = Center(
          child: Text("网络请求错误", style: TextStyle(color: Colours.text_gray_6),),
        );
        break;
